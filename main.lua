...
function love.load()
    ...
    damageFont = love.graphics.newFont("fonts/Abaddon Light.ttf",10)
...
function love.keypressed(key)
    ...
    elseif key == "return" and gameState == "cleared" then
        gameState = "play"
...
function love.draw()
    ...
    elseif gameState == "cleared" then
        ...
        love.graphics.printf("Press Enter for next Stage",0,100,gameWidth,"center")
